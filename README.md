...
**Team:** [Burapav] | **Location:** Coimbatore, Tamil Nadu  
...
India's gig economy has 7.7 million platform workers. Everyone talks about 
Zomato and Zepto riders. Nobody talks about **Delhivery's banking delivery partners** — 
...
### Scenario C: Bank Branch Bandh (Unique to This Persona)
...
>  
> Pranav has 21 banking deliveries. Zero can be completed — the 
...
not Bangalore-average data. HSR Layout flooding doesn't trigger a 
...
thunderstorm doesn't trigger a payout — it doesn't materially affect 
...
of banking document delivery. This is RideProtect's technical moat.
...
**Problem with naive approach:** OpenWeatherMap gives Bangalore-average 
...
This transparency is critical for trust — riders should understand 
...
**Layer 3: Delhivery Order Cross-Reference (Our Moat)**  
...
This gives the admin dashboard a genuinely useful, forward-looking 
metric that impresses Guidewire judges who understand reserve management.
...
Reasoning beyond "riders use phones":
...
## Product Features (The Details That Win)
...
This makes riders feel the product's value BEFORE the event. 
It builds daily engagement and trust.
...
This is not just UX — it's the trust mechanism that makes riders 
advocate for the product and eliminates disputes.
...
weather APIs every 30 minutes for potentially 500+ active riders' 
zones concurrently. FastAPI's async support handles this without 
blocking. Flask would require threading hacks.
...
### Phase 3 (April 5–17): Scale & Perfect
**Week 5:**
...
**Scalability:** The same engine works for:
...
- Directly supports Karnataka Gig Workers Welfare Board (2026) 
  mandate to provide social security for platform workers
